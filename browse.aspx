<%@ Page Title="" Language="C#" MasterPageFile="~/unlogged.master" AutoEventWireup="true" CodeFile="browse.aspx.cs" Inherits="browse" %>
                                    ...
                                    <table style="width:100%;">
                                        <tr>
                                            <td rowspan="3" style="width: 20%">
                                                <asp:HyperLink ID="HyperLink2" runat="server" ImageHeight="100px" ImageUrl='<%# Eval("bookCover") %>' ImageWidth="80px" NavigateUrl='<%# Eval("bookName", "detail.aspx?bookName={0}") %>'>HyperLink</asp:HyperLink>
                                            </td>
                                            <td colspan="2" style="height: 22px">
                                                <asp:HyperLink ID="HyperLink3" runat="server" CssClass="pub-title" NavigateUrl='<%# Eval("bookName", "detail.aspx?bookName={0}") %>' Text='<%# Eval("bookName") %>'></asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <asp:TemplateField HeaderText="browseall">
                                <ItemTemplate>
                                    <table style="width:100%;">
                                        <tr>
                                            <td rowspan="3" style="width: 20%">
                                                <asp:HyperLink ID="HyperLink4" runat="server" ImageHeight="100px" ImageUrl='<%# Eval("bookCover") %>' ImageWidth="80px" NavigateUrl='<%# Eval("bookName", "detail.aspx?bookName={0}") %>'>HyperLink</asp:HyperLink>
                                            </td>
                                            <td colspan="2" style="height: 22px">
                                                <asp:HyperLink ID="HyperLink5" runat="server" CssClass="pub-title" NavigateUrl='<%# Eval("bookName", "detail.aspx?bookName={0}") %>' Text='<%# Eval("bookName") %>'></asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="pub-desc" style="width: 40%">Author:
                                                <asp:Label ID="Label8" runat="server" CssClass="pub-desc" Text='<%# Eval("bookAuthor") %>'></asp:Label>
                                            </td>
                                            <td style="width: 40%">
