<%@ Page Title="" Language="C#" MasterPageFile="~/loggedmaster.master" AutoEventWireup="true" CodeFile="home.aspx.cs" Inherits="home" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                            ...
                            <ItemTemplate>
                                <table class="browse-display" style="width:100%;" cellpadding="4px">
                                    <tr>
                                        ...
                                        <td style="width: auto">
                                            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="pub-title" NavigateUrl='<%# Eval("bookName", "detailslogged.aspx?bookName={0}") %>' Text='<%# Eval("bookName") %>'></asp:HyperLink>
                                        </td>
    ...
    <br />
        ...
        <div class="content-figure-wrap">
            ...
            <center><asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="bookName" DataSourceID="SqlDataSource3" AllowSorting="True" CellPadding="4" CellSpacing="8" GridLines="None" ShowHeader="False" Width="80%" AllowPaging="True" PageSize="3">
                <Columns>
                    <asp:TemplateField>
                            <ItemTemplate>
                                <table class="auto-style3">
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:HyperLink ID="HyperLink2" runat="server" CssClass="pub-title" NavigateUrl='<%# Eval("bookName", "detailslogged.aspx?bookName={0}") %>' Text='<%# Eval("bookName") %>'></asp:HyperLink>
                                        </td>
                                    </tr>
                                    <tr>
